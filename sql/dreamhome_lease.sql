...
CREATE TABLE `lease` (
  `lease_no` varchar(20) NOT NULL,
  `client_no` varchar(20) NOT NULL,
  `property_no` varchar(20) DEFAULT NULL,
  ...
  CONSTRAINT `lease_ibfk_1` FOREIGN KEY (`client_no`) REFERENCES `property_client` (`id`),
  CONSTRAINT `lease_ibfk_2` FOREIGN KEY (`property_no`) REFERENCES `property` (`property_no`)
...
INSERT INTO `lease` VALUES ('l001','c001','p007','Debit','Y','2023-04-24','2023-10-24');
